...
import com.angular_springmvc.service.TrainService;
...
public class TrainController {
    ...
    public @ResponseBody List<Train> queryTrainsList() {
        return trainService.queryTrainsList();
    }
    
    @RequestMapping(value = "/getTrainById/{id}", method = RequestMethod.GET)
    public @ResponseBody Train getTrainById(@PathVariable("id") Long id) {
    	return trainService.getTrainById(id);
    }

    @RequestMapping(value = "/saveTrain", method = RequestMethod.POST)
    public @ResponseBody void saveTrain(@RequestBody Train train) {
    ...
    public @ResponseBody void removeTrainById(@PathVariable("id") Long id) {
